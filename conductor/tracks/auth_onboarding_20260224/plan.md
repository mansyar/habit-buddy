...
- [ ] Task: Configure Supabase Auth & Client
  - [ ] Write Tests: Create `src/lib/__tests__/supabase.test.ts` to verify client initialization.
  - [ ] Implement: Update `src/lib/supabase.ts` with `.env` variables and initialize.
